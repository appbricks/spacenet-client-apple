...
class UnlockTimeoutControls: NSView {
    ...
    init() {
        ...
        onDemandSSIDOptionsPopup.addItems(withTitles: UnlockTimeoutControls.onDemandSSIDOptions.map { $0.localizedUIString })
    ...
    func saveToViewModel() {
        ...
        onDemandViewModel.ssidOption = UnlockTimeoutControls.onDemandSSIDOptions[onDemandSSIDOptionsPopup.indexOfSelectedItem]
    ...
    func updateControls() {
        ...
        let optionIndex = UnlockTimeoutControls.onDemandSSIDOptions.firstIndex(of: onDemandViewModel.ssidOption)
    ...
    @objc func ssidOptionsPopupValueChanged() {
        ...
        onDemandViewModel?.ssidOption = UnlockTimeoutControls.onDemandSSIDOptions[selectedIndex]
        onDemandViewModel?.selectedSSIDs = (onDemandSSIDsField.objectValue as? [String]) ?? []
        updateControls()
...
extension UnlockTimeoutControls: NSTokenFieldDelegate {
