...
class StatusMenu: NSMenu {
    ...
    var snCtxMenu: SpaceNetContextMenu?
    ...
    init(tunnelsManager: TunnelsManager, windowDelegate: StatusMenuWindowDelegate) {
        self.tunnelsManager = tunnelsManager
        self.windowDelegate = windowDelegate

        super.init(title: tr("macMenuTitle"))

        snCtxMenu = SpaceNetContextMenu(addTo: self, windowDelegate: windowDelegate)
