...
enum TunnelsManagerError: SpaceNetClientError {
...
enum TunnelsManagerActivationAttemptError: SpaceNetClientError {
...
enum TunnelsManagerActivationError: SpaceNetClientError {
...
extension PacketTunnelProviderError: SpaceNetClientError {
    var alertText: AlertText {
        switch self {
