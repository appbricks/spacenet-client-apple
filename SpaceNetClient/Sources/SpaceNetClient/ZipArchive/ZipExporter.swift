...
enum ZipExporterError: SpaceNetClientError {
...
class ZipExporter {
    static func exportConfigFiles(tunnelConfigurations: [TunnelConfiguration], to url: URL, completion: @escaping (SpaceNetClientError?) -> Void) {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            } catch let error as SpaceNetClientError {
